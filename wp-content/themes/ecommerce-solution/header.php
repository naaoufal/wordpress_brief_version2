          ...
          <div class="row">
            ...
            <div class="col-lg-9 col-md-8 col-3">
              <div class="toggle-menu responsive-menu">
                <button role="tab" class="mobiletoggle" onclick="ecommerce_solution_responsive_menu_open()"><i class="<?php echo esc_attr(get_theme_mod('ecommerce_solution_responsive_menu_open_icon','fas fa-bars')); ?>"></i><span class="screen-reader-text"><?php esc_html_e('Open Menu','ecommerce-solution'); ?></span>
                </button>
              </div>
        ...
        <div class="container">
          <div class="row">          
            <div class="<?php if( get_theme_mod( 'ecommerce_solution_cart_enable_disable', true) != '') { ?> col-lg-10 col-md-9"<?php } else { ?>col-lg-12 col-md-12 <?php } ?>">
              <div class="toggle-menu responsive-menu">
                <button role="tab" class="mobiletoggle" onclick="ecommerce_solution_menu_open()" class="mobiletoggle"><i class="<?php echo esc_attr(get_theme_mod('ecommerce_solution_responsive_menu_open_icon','fas fa-bars')); ?>"></i><span class="screen-reader-text"><?php esc_html_e('Open Menu','ecommerce-solution'); ?></span>
                </button>
              </div>
