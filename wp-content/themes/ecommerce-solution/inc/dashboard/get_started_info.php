...
function ecommerce_solution_admin_theme_style() {
   wp_enqueue_style('ecommerce-solution-custom-admin-style', get_template_directory_uri() . '/inc/dashboard/get_started_info.css');
}
...
function ecommerce_solution_notice(){
    ...
    <div class="notice notice-success is-dismissible getting_started">
		<div class="notice-content">
			...
			<p><a href="<?php echo esc_url( admin_url( 'themes.php?page=ecommerce-solution-guide-page' ) ); ?>" class="button button-primary"><?php esc_html_e( 'Getting Started', 'ecommerce-solution' ); ?></a></p>
		</div>
	</div>
	<?php }
}
